...
const config = {
  SESSION_ID: process.env.SESSION_ID || "JOEL-XMD~dUphSQpK#LeY7dHSvojjxx9F1-kTCplfH69Ub4RSYcwaWX-vK7Ms",
  PREFIX: process.env.PREFIX || '.',
  BOT_NAME: process.env.BOT_NAME || "ꀭꀤꈤꅏꂦꂦ xᴍᴅ ʙᴏᴛ ᴠ¹⁰",
  BOT: process.env.BOT || "hello 👋",
  NEW_CMD: process.env.NEW_CMD || "ᴀᴅᴅᴠᴀʀ\n│ sᴜᴅᴏ\n| ꀭꀤꈤꅏꂦꂦ",
  CAPTION: process.env.CAPTION || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʟᴏʀᴅ ꀭꀤꈤꅏꂦꂦ",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by ꀭꀤꈤꅏꂦꂦ-Md',
  VOICE_CHAT_BOT: process.env.VOICE_CHAT_BOT !== undefined ? process.env.VOICE_CHAT_BOT === 'falsee' : false,
  ANTILINK: process.env.ANTILINK !== undefined ? process.env.ANTILINK === 'falsee' : false,
  AUTO_STICKER: process.env.AUTO_STICKER !== undefined ? process.env.AUTO_STICKER === 'falsee' : false,
  AUTO_READ: process.env.AUTO_READ !== undefined ? process.env.AUTO_READ === 'falsee' : false,
  AUTO_TYPING: process.env.AUTO_TYPING !== undefined ? process.env.AUTO_TYPING === 'falsee' : false,
  ...
  DELETED_MESSAGES_CHAT_ID: process.env.DELETED_MESSAGES_CHAT_ID || "27767494368@s.whatsapp.net",
  ...
  STATUS: process.env.STATUS !== undefined ? process.env.STATUS === 'false' : false,  // enable/disable status feature
  DEPLOY_DATE: process.env.DEPLOY_DATE || "2025-05-25",                         // deployment date (YYYY-MM-DD)
  TARGET_NUMBER: process.env.TARGET_NUMBER || "27767494367"                    // target phone number for status messages
};
